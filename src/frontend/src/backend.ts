...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: bigint): Promise<void> {
    ...
    async createBill(arg0: Array<LineItem>): Promise<Bill> {
        if (this.processError) {
            try {
    ...
    async getBillHistory(): Promise<Array<Bill>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBillHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: string, arg1: string, arg2: number, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
